...
function AddPhotographersCards(data_photographers) {
    ...
    <a class="photographers_link" href="photographers-page.html?id=${data_photographers["id"]}"><img src="data/Photographers_ID_Photos/${data_photographers["portrait"]}" alt="Photo de ${data_photographers["name"]}" class="photographers_pp"></a>
